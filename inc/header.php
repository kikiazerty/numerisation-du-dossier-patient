...
<!-- rajout css et scripts pour nouveau calendrier intégration Yanick MORZA  -->
...
<!-- rajout scripts pour masque de saisie intégration Yanick MORZA  -->
<script type="text/javascript" src="scripts/jquery/jquery-maskedinput-1.3.min.js"></script>
	<script type="text/javascript">
		jQuery(function($){
		  $("#rpps_corresp").mask("99999999999");
		});
	</script>
	<script type="text/javascript">
		jQuery(function($){
		  $("#ordre_corresp").mask("999999999");
		});
	</script>
	<script type="text/javascript">
		jQuery(function($){
